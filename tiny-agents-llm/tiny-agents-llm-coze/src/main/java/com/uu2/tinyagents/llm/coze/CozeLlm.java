...
public class CozeLlm extends BaseLlm<CozeLlmConfig> {
    ...
    private void botChat(Prompt prompt, CozeRequestListener listener, ChatOptions chatOptions, boolean stream) {
        ...
        String payload = CozeLlmUtil.promptToPayload(prompt, botId, userId, customVariables, config.isAutoSaveHistory(), stream);
    ...
    @Override
    public EmbedData embed(EmbeddingOptions options, String... documments) {
